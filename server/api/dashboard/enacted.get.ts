 ...
 * stops at the Regierungsvorlage (88/ME ends with "Regierungsvorlage (474
 * d.B.)"; the Kundmachung is on the Vorlage). Walking our own closed drafts
 * would therefore cost two fetches per row to learn what one fetch on the
 * Vorlage says, and it would still miss a law whose Begutachtung ended long
 * before the vote.
 *
