 ...
 * "Krejci, Florian; Dr. med. dent."), all-caps ("KOLLROSS, PETER") and digits
 * ("Scheer, Ma8").
 *
...
const ORG_PATTERNS: RegExp[] = [
  ...
  /\bnationalbank\b|\bbank\b/i, // "Vonbank, Christine" has no boundary before "bank"
  /allianz\b/i,
  /\bliga\b/i, // "Gliga, Dorian" is a surname
  /föderation/i,
 ...
 * take an optional dot: "Weilguny BEd., Renate" is how the form is filled
 ...
 * a title with one to three name tokens ("Maderbacher Gregor, Dr."). With
...
function isPersonShaped(segment: string, bare = false): boolean {
  ...
  if (!raw) return false
  // "häuser, roland" is a person who did not reach for the shift key; the
 ...
 * Salzburg", "Maderbacher Gregor, Dr.; Rechtsanwalt; … Rechtsanwälte GesbR",
