...
- [RIS-Join](docs/ris-join.md) — how Parliament's Ministerialentwürfe are matched to their RIS draft texts: corpus test on GP XXVII, the rule, its failure modes, and what it means for the diff layer
